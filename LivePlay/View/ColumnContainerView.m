...
@interface ColumnContainerView ()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, XMGWaterflowLayoutDelegate>
@property (nonatomic, strong) UICollectionView *collectionView;


@end

@implementation ColumnContainerView
...
- (WaterflowLayout *)getFlowLayout {
//    ColumnCollectionViewFlowLayout *flowLayout = [[ColumnCollectionViewFlowLayout alloc] init];
...
//        if (indexPath.row == 0) {
//            return CGSizeMake((collectionView.bounds.size.width-5)/2, (collectionView.bounds.size.width-5)/2+10);
//        }else {
//            return CGSizeMake((collectionView.bounds.size.width-5)/2, (collectionView.bounds.size.width-5)/2+30);
//        }
//    }
//    return CGSizeZero;
//}
...
//    return itemWidth*shop.h/shop.w;
    if (index == 0) {
        return (self.collectionView.bounds.size.width-5)/2+10;
    }else {
        return (self.collectionView.bounds.size.width-5)/2+30;
    }
    return 0;
}
